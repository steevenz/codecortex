...
def test_extract_heritage_from_files():
    from src.domain.codegraph.application.heritage_extractor import extract_heritage_from_files
    files = [
...
def test_import_resolver_ts_require():
    from src.domain.codeindex.infrastructure.import_resolvers import TypeScriptImportResolver
...
def test_import_resolver_python_import():
    from src.domain.codeindex.infrastructure.import_resolvers import PythonImportResolver
...
def test_knowledge_graph_add_relationship_no_node():
    from src.domain.codegraph.core.knowledge_graph import KnowledgeGraph, GraphRelationship, RelationshipType
    kg = KnowledgeGraph()
...
def test_knowledge_graph_get_relationships_by_type_empty():
    from src.domain.codegraph.core.knowledge_graph import KnowledgeGraph, RelationshipType
    kg = KnowledgeGraph()
