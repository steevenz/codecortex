...
def test_entry_point_scorer_empty_name():
    from src.modules.codegraph.core.entry_point import EntryPointScorer, bulk_score_symbols
...
def test_bulk_score_symbols_empty():
    from src.modules.codegraph.core.entry_point import bulk_score_symbols
...
def test_create_index_worker_pool_default():
    from src.modules.codeindex.parsers.worker_pool import create_index_worker_pool
...
def test_framework_detect_gin():
    from src.modules.codeindex.services.framework_detection import detect_from_source
...
def test_extract_routes_from_files_empty():
    from src.modules.codegraph.core.route import extract_routes_from_files
...
def test_import_resolver_unknown_language():
    from src.modules.codeindex.parsers.import_resolvers import resolve_imports_for_file, SuffixIndex
    files = {"main.rs"}
...
def test_suffix_index_empty():
    from src.modules.codeindex.parsers.import_resolvers import SuffixIndex
    idx = SuffixIndex(set())
...
def test_extract_orm_from_files_empty():
    from src.modules.codegraph.core.orm import extract_orm_from_files
