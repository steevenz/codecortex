...
def test_cosine_similarity():
    import numpy as np
    from src.modules.codeindex.parsers.embeddings import cosine_similarity
...
def test_index_file_embeddings():
    from src.modules.codeindex.parsers.embeddings import index_file_embeddings
    with tempfile.TemporaryDirectory() as tmpdir:
        db_path = str(Path(tmpdir) / "emb.db")
        content = "def hello():\n    print('world')\n\nclass App:\n    def run(self):\n        pass\n"
...
def test_semantic_search():
    from src.modules.codeindex.parsers.embeddings import semantic_search, index_file_embeddings
    with tempfile.TemporaryDirectory() as tmpdir:
        db_path = str(Path(tmpdir) / "emb.db")
