...
def test_cobol_is_cobol_file():
    from src.modules.codeindex.parsers.parsers.languages.cobol import is_cobol_file
...
def test_cobol_parse_program_id():
    from src.modules.codeindex.parsers.parsers.languages.cobol import extract_cobol_symbols
...
def test_cobol_parse_via_parser():
    from src.modules.codeindex.parsers.parsers.languages.cobol import parse_cobol
...
def test_vue_extract_sections():
    from src.modules.codeindex.parsers.parsers.languages.vue import extract_vue_sections
    content = """<template>
  <div>
    <MyComponent />
  </div>
...
def test_vue_parse():
    from src.modules.codeindex.parsers.parsers.languages.vue import parse_vue
    with tempfile.TemporaryDirectory() as tmpdir:
...
def test_generic_parse_julia():
    from src.modules.codeindex.parsers.parsers.languages.generic_ts import parse_julia
    with tempfile.TemporaryDirectory() as tmpdir:
...
def test_generic_parse_lua():
    from src.modules.codeindex.parsers.parsers.languages.generic_ts import parse_lua
    with tempfile.TemporaryDirectory() as tmpdir:
...
def test_generic_parse_zig():
    from src.modules.codeindex.parsers.parsers.languages.generic_ts import parse_zig
    with tempfile.TemporaryDirectory() as tmpdir:
...
def test_language_aliases():
    from src.core.parser.tree_sitter_manager import get_tree_sitter_manager
