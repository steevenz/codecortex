...
def test_sbd_by_markers():
    from src.modules.codegraph_boundary import detect_service_boundaries
...
def test_sbd_service_boundary_class():
    from src.modules.codegraph_boundary import ServiceBoundary
...
def test_mro_simple():
    from src.modules.codegraph.core.mro import c3_linearize
...
def test_mro_compute():
    from src.modules.codegraph.core.mro import compute_mro
    heritage = {"D": ["B", "C"], "B": ["A"], "C": ["A"], "A": []}
...
def test_mro_detect_overrides():
    from src.modules.codegraph.core.mro import detect_method_overrides, compute_mro
    from src.modules.codegraph.core.mro import ClassInfo
    classes = {
...
def test_mro_build_heritage():
    from src.modules.codegraph.core.mro import build_heritage_map_from_symbols
    symbols = [
...
def test_wi_is_wildcard():
    from src.modules.codeindex.parsers.wildcard_imports import is_wildcard_import
...
def test_wi_get_exported_python():
    from src.modules.codeindex.parsers.wildcard_imports import get_exported_symbols
    content = """
def public_func():
    pass
...
def test_wi_synthesize():
    from src.modules.codeindex.parsers.wildcard_imports import synthesize_wildcard_imports
    files = {
...
def test_wi_quick_resolve():
    from src.modules.codeindex.parsers.wildcard_imports import quick_wildcard_resolve
