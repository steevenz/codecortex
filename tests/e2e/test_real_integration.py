...
def test_tsm_get_language():
    from src.core.parser.tree_sitter_manager import get_tree_sitter_manager, get_language_safe, create_parser
...
def test_tsm_multiple_languages():
    from src.core.parser.tree_sitter_manager import get_language_safe, create_parser
...
def test_tsm_unknown_language():
    from src.core.parser.tree_sitter_manager import get_language_safe
...
def test_tsp_python_parse_class():
    from src.modules.codeindex.parsers.parsers.tree_sitter_parser import TreeSitterParser
    import tempfile
...
def test_python_parser_class_extraction():
    from src.modules.codeindex.parsers.parsers.languages.python import PythonTreeSitterParser
    from src.modules.codeindex.parsers.parsers.tree_sitter_parser import TreeSitterParser
    import tempfile
...
def test_frameworks_django():
    from src.modules.codeindex.parsers.parsers.frameworks.django import detect_django
    from src.modules.codeindex.parsers.parsers.frameworks.django import enrich_class
...
def test_frameworks_react():
    from src.modules.codeindex.parsers.parsers.frameworks.react import detect_react
    result = detect_react(
...
def test_frameworks_vue():
    from src.modules.codeindex.parsers.parsers.frameworks.vue import detect_vue
    result = detect_vue(
        rel_path="App.vue",
...
def test_frameworks_angular():
    from src.modules.codeindex.parsers.parsers.frameworks.angular import detect_angular
...
def test_frameworks_express():
    from src.modules.codeindex.parsers.parsers.frameworks.express import detect_express
...
def test_frameworks_flutter():
    from src.modules.codeindex.parsers.parsers.frameworks.flutter import detect_flutter
...
def test_frameworks_nextjs():
    from src.modules.codeindex.parsers.parsers.frameworks.nextjs import detect_nextjs, detect_react
...
def test_frameworks_laravel():
    from src.modules.codeindex.parsers.parsers.frameworks.laravel import detect_laravel
...
def test_frameworks_nestjs():
    from src.modules.codeindex.parsers.parsers.frameworks.nestjs import detect_nestjs
...
def test_frameworks_rails():
    from src.modules.codeindex.parsers.parsers.frameworks.rails import detect_rails
    result = detect_rails(
...
def test_frameworks_symfony():
    from src.modules.codeindex.parsers.parsers.frameworks.symfony import detect_symfony
...
def test_frameworks_aspnet():
    from src.modules.codeindex.parsers.parsers.frameworks.aspnet import detect_aspnet
