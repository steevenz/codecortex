...
def test_estimate_tokens():
    from src.core.token_economy import estimate_tokens
    assert estimate_tokens("hello world") > 0
    assert estimate_tokens("") == 0


def test_truncate():
    from src.core.token_economy import truncate_to_budget
...
def test_summarize():
    from src.core.token_economy import smart_summarize
    code = "import os\nimport sys\n\ndef hello():\n    print('hi')\n    x = 1\n"
...
def test_cache():
    from src.core.token_economy import TokenCache
    c = TokenCache(10, 60)
...
def test_optimize_dict():
    from src.core.token_economy import optimize_response
...
def test_budget():
    from src.core.token_economy import get_token_budget
    b = get_token_budget()
    assert 100 <= b <= 32000


def test_mcp_summary():
    from src.core.token_economy import mcp_response
