...
myawesomeproject is a greenfield project initialized with python stack and Web API Project (FastAPI) pattern.
...
CLI domain name: myawesomeproject
Aliases: mya
...
| Prefix | Tool |
|--------|------|
| MYAWESOMEPROJECT_001 | Validation errors |
| MYAWESOMEPROJECT_002 | Not found errors |
| MYAWESOMEPROJECT_500 | Internal errors |
