...
/**
 * @project   CodeCortex
 * @package   Domain/Repository/Infrastructure
 * @author    Steeven Andrian
 * @copyright (c) 2026 Aegis Codework
 * @standard  Aegis-CrossStack-v1.0
 * @stack     Python, GitPython
 * * Class GitAdapter – Wrapper for GitPython to interact with local repositories.
 */
"""
...
class GitAdapter:
    def __init__(self, repo_path: Path):
        ...
        try:
            ...
            logger.error(f"Error initializing GitAdapter: {e}")
