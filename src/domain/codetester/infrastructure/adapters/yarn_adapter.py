...
class YarnAdapter(BaseQAAdapter):
    def run(self, repo_path: str, target_path: Optional[str] = None, extra_args: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"tool": "yarn", "status": "error", "error": "yarn test execution timed out"}
        except Exception as e:
            # Avoid leaking internal error details in production
            return {"tool": "yarn", "status": "error", "error": "An error occurred while running yarn test"}
