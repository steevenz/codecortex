...
:project: CodeCortex
:package: Modules.Codeindex.Services.Framework_detection
...
_FRAMEWORK_PATTERNS: Dict[str, List[Dict]] = {
    ...
    # Svelte / SvelteKit
    "svelte": [
        {"type": "file", "pattern": r"\.svelte$", "confidence": "high"},
        {"type": "file", "pattern": r"\+page\.svelte$|\+layout\.svelte$", "confidence": "high"},
        {"type": "import", "pattern": r"from ['\"]svelte['\"]|from ['\"]svelte/|from ['\"]\\$app/", "confidence": "high"},
        {"type": "manifest", "key": "svelte", "confidence": "high"},
        {"type": "manifest", "key": "@sveltejs/kit", "confidence": "high"},
    ],
    # SolidJS
    "solidjs": [
        {"type": "import", "pattern": r"from ['\"]solid-js['\"]|from ['\"]solid-js/|from ['\"]@solidjs/", "confidence": "high"},
        {"type": "manifest", "key": "solid-js", "confidence": "high"},
        {"type": "file", "pattern": r"createSignal|createEffect|createMemo", "confidence": "medium"},
    ],
    # Tauri (Rust desktop framework with web frontend)
    "tauri": [
        {"type": "file", "pattern": r"tauri\.conf\.(json|json5)$", "confidence": "high"},
        {"type": "file", "pattern": r"src-tauri/", "confidence": "high"},
        {"type": "import", "pattern": r"use tauri::|tauri::command", "confidence": "high"},
        {"type": "import", "pattern": r"from ['\"]@tauri-apps/", "confidence": "high"},
        {"type": "manifest", "key": "@tauri-apps/api", "confidence": "high"},
    ],
    # Astro
    "astro": [
        {"type": "file", "pattern": r"\.astro$", "confidence": "high"},
        {"type": "file", "pattern": r"astro\.config\.(mjs|ts|js|cjs)$", "confidence": "high"},
        {"type": "import", "pattern": r"from ['\"]astro['\"]|from ['\"]astro:", "confidence": "high"},
        {"type": "manifest", "key": "astro", "confidence": "high"},
    ],
}
